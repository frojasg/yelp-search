...
* I didn't like to use the ``` didSelectRowAtIndexPath ``` method to select the single selection filter

## License

    Copyright 2015 Francisco Rojas <francisco.rojas.gallegos@gmail.com>
